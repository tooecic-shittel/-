...
def get_task(
    ...
    if task:
        ...
        if "digital_human_video" in task and task["digital_human_video"]:
            response_task["digital_human_video"] = _task_file_to_uri(
                task["digital_human_video"], endpoint, task_dir, request_id
            )
